    ...
    <>
      <div className="flex-start w-full flex-col">
        <div className="flex w-full flex-col-reverse justify-between gap-5 sm:flex-row sm:items-center sm:gap-2">
          <Link
            href={`/profile/${result.author.clerckId}`}
          ...
          <div className="flex justify-end">
            <Votes 
              type='Question' // where we vote , in the question or in the answer
              userId={JSON.stringify(mongoUser._id)} // the user who vote
              itemId={JSON.stringify(result._id)} // the item who voted , (item = question or answer)
